            ...
            <div class="row">
                ...
                <div class="col-8">
                    <div class="detail-rating">
                        @foreach($course->starRating as $starRating)
                            <div class="row detail-rating-align">
                                ...
                                <div class="col-9 p-0 progress detail-rating-progress">
                                    <div class="progress-bar" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width: {{ $course->number_review > config('app.process_min') ? $starRating->total / $course->number_review * config('app.process_max') : config('app.process_min') }}%"></div>
                                </div>
