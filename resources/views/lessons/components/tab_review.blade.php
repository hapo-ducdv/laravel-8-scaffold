<div class="tab-pane fade" id="pillsReview" role="tabpanel" aria-labelledby="pillsReviewTab">
    <div class="progress">
            ...
            <div class="row">
                ...
                <div class="col-8">
                    <div class="detail-rating">
                        @foreach($lesson->star_rating as $key => $rating)
        ...
        @foreach($reviews as $review)
            <li class="list-group-item">
                <div class="media reviews-first">
                    <img src="{{ asset('' . $review->users->avatar . '') }}" class="rounded-circle review-image" alt="">
