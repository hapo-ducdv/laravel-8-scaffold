...
<div class="container statistic cih">
    ...
    <div class="row statistic-content">
        <div class="col-12 col-md-4 d-flex flex-column align-items-center">
            ...
            <div class="statistic-content-number">{{ number_format($totalCourse, config('app.decimal'), ',', '.') }}</div>
        </div>
        <div class="col-12 col-md-4 d-flex flex-column align-items-center">
            <div class="statistic-content-title">Lessons</div>
            <div class="statistic-content-number">{{ number_format($totalLesson, config('app.decimal'), ',', '.') }}</div>
        </div>
        <div class="col-12 col-md-4 d-flex flex-column align-items-center">
            <div class="statistic-content-title">Learns</div>
            <div class="statistic-content-number">{{ number_format($totalUser, config('app.decimal'), ',', '.') }}</div>
        </div>
    </div>
</div>
